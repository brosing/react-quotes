    ...
    return quote === null
      ...
      : (
        <div className='content'>
          ...
          {/* EMBED */}
          <a style={{position: 'absolute', bottom: '30px', backgroundColor: '#0f0f0f', color: 'white', textDecoration: 'none', padding: '4px 6px', fontSize: 12, fontWeight: 'bold', lineHeight: '1.2', display: 'inline-block', borderRadius: 3}} href='https://unsplash.com/@anthonydelanoix?utm_medium=referral&utm_campaign=photographer-credit&utm_content=creditBadge' target='_blank' rel='noopener noreferrer' title='Download free do whatever you want high-resolution photos from Anthony DELANOIX'>
            ...
            <span style={{display: 'inline-block', padding: '2px 3px'}}>Anthony DELANOIX</span>
          </a>
        </div>
      )
  }
